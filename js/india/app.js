...
function phoneData(idIndex, jsonDataIndex ,fileFormat, brand ,normalPrice, name ,img) {
  ...
  if (brand == "a") {
      document.getElementById('price-se'+idIndex).innerHTML = JsonData.slice(0,-3)  ;
      document.getElementById('brand-se'+idIndex).src = "/img/amazon.jpg"  ;
      document.getElementById("img-se"+idIndex).style.width = "200px";
  ...
  if (brand == "f"){
     document.getElementById('price-se'+idIndex).innerHTML = fileFormat.links[jsonDataIndex].price  ;  
      document.getElementById('brand-se'+idIndex).src = "/img/flipkart.jpg"  ;
      document.getElementById("img-se"+idIndex).style.width = "80px";
      document.getElementById("img-se"+idIndex).style.height = "150px";
      document.getElementById("img-se"+idIndex).style.left = "10px";
      document.getElementById("img-se"+idIndex).style.top= "10px";
