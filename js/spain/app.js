...
function phoneData(idIndex, jsonDataIndex ,fileFormat, brand ,normalPrice, name ,img) {
  ...
  document.getElementById('price-se'+idIndex).innerHTML = fileFormat.links[jsonDataIndex].price.slice(0,-5) + " €"  ;
  ...
  if (brand == "es") {
   ...
   document.getElementById('img-se'+idIndex).style.width = "70px"; 
   document.getElementById('img-se'+idIndex).style.left = "10px"; 
  ...
  if (brand == "mkr"){
      ...
      document.getElementById('brand-se'+idIndex).src = "/img/mediamarkt-full.jpg"  ;
      document.getElementById('brand-se'+idIndex).style.width = "80px"; 
      document.getElementById('brand-se'+idIndex).style.left = "130px";
      document.getElementById('img-se'+idIndex).style.width = "130px"; 
      document.getElementById('img-se'+idIndex).style.left = "-10px"; 
        ...
        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          b.addEventListener("click", function(e) {
              ...
              if (inp.value.slice(0,6) == "iphone") {
                location.replace("/spain/apple/"+inp.value.replace(/ /g,"-")+".html");
                  
              }else if (inp.value.slice(0,7) == "samsung"){
                location.replace("/spain/samsung/"+inp.value.replace(/ /g,"-")+".html");
              }
